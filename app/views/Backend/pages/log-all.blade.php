    ...
    <div class="col-md-12 form-group">
        <div class="table-filter col-md-12 row">
            <form action="" method="get" accept-charset="utf-8">
                ...
                <div class="col-md-3">
                    <input name="user_id" autocomplete="on" value="{{Input::get('user_id')}}" placeholder="操作者ID" class="form-control"/>            
                </div>
                <div class="col-md-1">
            ...
            <table class="table table-hover">
                ...
                @foreach($logs as $i => $log)
                    ...
                    <tr class="{{ $i == 0 ? 'first' : '' }}">
                        ...
                        <td>
                        @if($log->user)
                        <a href="">{{ !empty($log->user->nickname) ? $log->user->nickname : $log->user->email }}</a>
                        @else
                        无
                        @endif
                        </td>
